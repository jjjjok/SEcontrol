        ...
        <div class="crumb-wrap">
            ...
            <div class="result-wrap">
                <div class="result-content">
                    <form action="${pageContext.request.contextPath}/upload/appeal?orderid=${oid}" method="post" id="myform" name="myform" enctype="multipart/form-data">
                        <table class="insert-tab" width="100%">
                            <tbody><tr>
                                <th width="120"><i class="require-red">*</i>请选择申诉理由：</th>
                                <td>
                            ...
                            <tr>
                                <th><i class="require-red">*</i>请补充描述，以便管理员更好处理：</th>
