...
<div class="Bott">
    <div class="wrapper clearfix">
        ...
        <div class="you fl">
            <div class="my clearfix"><h2>退款详情</h2>
                <h3>订单号：<span>${refund.order_id}</span></h3></div>
            <div class="orderList">

                <div class="orderList1"><h3>退款信息</h3>
                    <p>姓 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：<span>${username}</span></p>
                    <p>联系电话：<span>${userphone}</span></p>

            </div>
                <div class="orderList1"><h3>退款原因</h3>
                    <div class="clearfix">
                        <p>退款原因：<span>${refund.refund_rea}</span></p>
                        <c:if test="${not empty refund.refund_img}">
                        <a href="#" class="fl"><img src="${pageContext.request.contextPath}/imgs/${refund.refund_img}"/></a>
                        </c:if>
                        <p class="fl"><a href="#">${refund.refund_inf}</a></p></div>
                </div>
        </div>
    </div>
