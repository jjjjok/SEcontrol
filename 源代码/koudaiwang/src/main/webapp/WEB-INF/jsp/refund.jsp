        ...
        <div class="crumb-wrap">
            ...
            <div class="result-wrap">
                <div class="result-content">
                    <form action="${pageContext.request.contextPath}/upload/refund?orderid=${oid}" method="post" id="myform" name="myform" enctype="multipart/form-data">
                        <table class="insert-tab" width="100%">
                            <tbody><tr>
                                <th width="120"><i class="require-red">*</i>请选择退款理由：</th>
                                <td>
                                    <select name="fl" id="catid" class="required">
                                        <option value="">请选择</option>
                                        <option value="1">我不想要了</option>
                                        <option value="2">没收到货</option>
                                        <option value="3">商品与实物不符</option>
                                        <option value="4">未按约定时间发货</option>
                                        <option value="5">拍错了</option>
                                    </select>
                                </td>
                            </tr>
