            ...
            <div class="dkuang">
                ...
                <div class="word clearfix">
                    ...
                    <ul class="fl clearfix">
                        ...
                        <li><a href="${pageContext.request.contextPath}/user/senddetail?id=${order.order_id}">查看物流详情</a></li>
                        </c:if>
                    </ul>
                ...
                <div class="shohou clearfix"><a href="#" class="fl"><img src="${pageContext.request.contextPath}/imgs/${order.item_img}"/></a>
                    ...
                    <p class="fr"><a>等待发货</a>
                        <a href="${pageContext.request.contextPath}/user/torefund?id=${order.order_id}">退款</a></p>
                </c:if>
                <c:if test="${order.order_state==2}">
