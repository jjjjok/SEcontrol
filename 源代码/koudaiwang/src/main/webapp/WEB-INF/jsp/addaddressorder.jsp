...
<div class="reg">
    <form action="${pageContext.request.contextPath}/item/addressadd" method="post" onsubmit="return CheckForm(this)">
        <p><input type="text" name="name" value="" onfocus="FocusItem(this)" onblur="CheckItem(this)" placeholder="收件人" ><span class="empty"></span></p>
        <p><input type="text" name="userphone" value="" onfocus="FocusItem(this)" onblur="CheckItem(this)" placeholder="联系电话" ><span class="empty"></span></p>
        <p><input type="text" name="address" value="" onfocus="FocusItem(this)" onblur="CheckItem(this)" placeholder="详细地址" ><span class="empty"></span></p>
