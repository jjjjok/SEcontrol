...
<div class="reg">
    <form action="${pageContext.request.contextPath}/user/addsend" method="post" onsubmit="return CheckForm(this)">
        <p><input type="text" name="oid" value="${oid}" onfocus="FocusItem(this)" onblur="CheckItem(this)" placeholder="订单编号" ><span class="empty"></span></p>
        <p><input type="text" name="name" value="" onfocus="FocusItem(this)" onblur="CheckItem(this)" placeholder="物流公司" ><span class="empty"></span></p>
        <p><input type="text" name="sendid" value="" onfocus="FocusItem(this)" onblur="CheckItem(this)" placeholder="物流编号" ><span class="empty"></span></p>
