                ...
                <div class="dkuang"><p class="one"></p>
                    <div class="word clearfix">
                        <ul class="fl clearfix">
                            ...
                            <li>订单编号:${order.order_id}</li>
                                ...
                                <a href="${pageContext.request.contextPath}/user/goodchangedetail?id=${order.order_id}">查看换货详情</a>
                    ...
                    <div class="shohou clearfix"><a href="#" class="fl"><img src="${pageContext.request.contextPath}/imgs/${order.item_img}"/></a>
                        ...
                        <c:if test="${order.order_state==11}">
                            <p class="fr">
                                <a href="${pageContext.request.contextPath}/user/changechecked?url=12&id=${order.order_id}">同意换货</a>
                                <a href="${pageContext.request.contextPath}/user/changechecked?url=13&id=${order.order_id}">不同意换货</a></p>
                        </c:if>
                        <c:if test="${order.order_state==12}">
                            <p class="fr"><a href="${pageContext.request.contextPath}/user/toaddsendchange?id=${order.order_id}">重新发货</a></p>
                        </c:if>
